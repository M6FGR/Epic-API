...
// same as SimpleStaticAnimation, but with custom playspeed and advanced reverse play
public class SimpleMovementAnimation extends SimpleStaticAnimation {
    ...
    public boolean canBePlayedReverse() {
        // ONLY plays backwards if the player was actually looking back, not pressing S
